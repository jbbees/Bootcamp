...
# using the sum() function won't work because sum() only takes 2 arguments.
...
if total_cost <= budget:
    print(f"Your total cost is ${total_cost}, well within your budget of ${budget}")
else:
...
if rent_cost > sum(utilities_cost, food_cost, transportation_cost):
    print("The rent is too daman high!")
else:
